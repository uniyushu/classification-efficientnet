...
from pruning.distributed_manager import DistributedManager
...
def compute_next_bn_resnet(layer_name, resnet):
    ...
    assert extract_layer(resnet, next_bn).__class__.__name__ == 'BatchNorm2d' or \
           extract_layer(resnet, next_bn).__class__.__name__ == 'SyncBatchNorm' or \
           extract_layer(resnet, next_bn).__class__.__name__ == 'BatchNormAct2d'
    return next_bn
